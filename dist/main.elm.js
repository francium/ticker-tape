...
var _user$project$Ticker_Api$quoteUrlStockPlaceholder = '{{ stock }}';
var _user$project$Ticker_Api$quoteUrl = A2(
	_elm_lang$core$Basics_ops['++'],
	'https://api.iextrading.com/1.0/stock/',
	A2(_elm_lang$core$Basics_ops['++'], _user$project$Ticker_Api$quoteUrlStockPlaceholder, '/book'));
var _user$project$Ticker_Api$stockQuoteUrlBuilder = function (stock) {
	return A3(_elm_community$string_extra$String_Extra$replace, _user$project$Ticker_Api$quoteUrlStockPlaceholder, stock, _user$project$Ticker_Api$quoteUrl);
};
...
var _user$project$Ticker_Api$quoteDataDecoder = A7(
	...
	_user$project$Ticker_Api$QuoteModel,
...
var _user$project$Ticker_Api$quoteDecoder = A2(
	...
	_user$project$Ticker_Api$quoteDataDecoder);
var _user$project$Ticker_Api$getQuote = F2(
	function (msg, stock) {
		return A2(
			...
			A2(
				...
				_user$project$Ticker_Api$stockQuoteUrlBuilder(stock),
				_user$project$Ticker_Api$quoteDecoder));
	});
...
var _user$project$Ticker_Ticker$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('Ticker'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('TickerCompany'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
				...
				_0: A2(
					...
					},
					{
						...
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(model.price)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('TickerStartingPrice'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(model.startingPrice)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('TickerTime'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
...
var _user$project$Ticker_Ticker$Model = F5(
	function (a, b, c, d, e) {
		return {symbol: a, price: b, startingPrice: c, time: d, latestUpdate: e};
	});
			...
			case 'QuoteUpdate':
				...
				if (_p1.ctor === 'Ok') {
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{price: _p2.latestPrice, latestUpdate: _p2.latestUpdate, startingPrice: _p2.open}),
						{ctor: '[]'});
				} else {
...
var _user$project$Ticker_Ticker$TimeNow = function (a) {
	return {ctor: 'TimeNow', _0: a};
};
var _user$project$Ticker_Ticker$init = F3(
	function (symbol, price, startingPrice) {
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			A5(_user$project$Ticker_Ticker$Model, symbol, price, startingPrice, 0, 0),
			{
				ctor: '::',
				_0: A2(_elm_lang$core$Task$perform, _user$project$Ticker_Ticker$TimeNow, _elm_lang$core$Time$now),
				_1: {ctor: '[]'}
			});
	});
var _user$project$Ticker_Ticker$Tick = function (a) {
...
var _user$project$Main$AddTicker = {ctor: 'AddTicker'};
var _user$project$Main$TickerMsg = F2(
	function (a, b) {
		return {ctor: 'TickerMsg', _0: a, _1: b};
	});
var _user$project$Main$updateTickers = F3(
	function (key, subMsg, tickers) {
		var maybeTicker = A2(_elm_lang$core$Dict$get, key, tickers);
		var maybeUpdated = function () {
			var _p0 = maybeTicker;
			if (_p0.ctor === 'Just') {
				return _elm_lang$core$Maybe$Just(
					A2(_user$project$Ticker_Ticker$update, subMsg, _p0._0));
			} else {
				return _elm_lang$core$Maybe$Nothing;
			}
		}();
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p3.ctor) {
			case 'AddTicker':
				var _p4 = A3(_user$project$Ticker_Ticker$init, model.inputText, 0, 0);
				var ticker = _p4._0;
				var subCmd = _p4._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		},
		{
					...
					_0: A2(
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$placeholder('Stock name'),
									_1: {ctor: '[]'}
								}
							}
						},
			...
			_1: {
				ctor: '::',
				_0: _user$project$Main$viewTickers(model.tickers),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$init = function () {
	...
	var _p10 = {
		...
		_1: A2(
			_elm_lang$core$List$map,
			function (sym) {
				return A3(_user$project$Ticker_Ticker$init, sym, 0, 0);
			},
			_user$project$Main$initialSymbols)
	};
	var symbols = _p10._0;
	...
	var tickerCmdsMapped = A3(
		...
		F2(
			function (sym, subCmd) {
				return A2(
					_elm_lang$core$Platform_Cmd$map,
					_user$project$Main$TickerMsg(sym),
					subCmd);
			}),
		symbols,
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Ticker.Ticker.Msg":{"args":[],"tags":{"Tick":["Time.Time"],"TimeNow":["Time.Time"],"QuoteUpdate":["Result.Result Http.Error Ticker.Api.QuoteModel"],"PriceChange":["Float"]}},"Main.Msg":{"args":[],"tags":{"UpdateInputText":["String"],"TickerMsg":["String","Ticker.Ticker.Msg"],"AddTicker":[],"Noop":[]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Ticker.Api.QuoteModel":{"args":[],"type":"{ symbol : String , companyName : String , primaryExchange : String , open : Float , latestPrice : Float , latestUpdate : Time.Time }"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Time.Time":{"args":[],"type":"Float"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
